    ...
    <div className="washi-bg flex h-[100svh] flex-col overflow-hidden text-fog">
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col">
          ...
          {/* 일정: 좌 타임라인 / 우 지도 (lg+) — 각자 스크롤·지도는 고정 높이 */}
          {tab === 'itinerary' ? (
            <div className="grid min-h-0 flex-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)]">
              <section className="relative min-h-0 overflow-y-auto overscroll-contain border-b border-white/10 p-3 lg:border-b-0 lg:border-r lg:p-4">
                <img
              ...
              <p className="border-t border-white/10 px-3 py-2 text-[11px] text-mist/50 lg:hidden">
                지도는 위 「지도」 탭에서 볼 수 있어요.
              </p>
            </div>
          ) : null}
